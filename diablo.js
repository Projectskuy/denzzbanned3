...
//=================================================//   
const reply = (teks) => {
return diablo.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC REYYBOTZ`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"6281389368689Url": `https://youtube.com/@azaaalynne`}}}, { quoted: m })} 	
//=================================================// 
try {
...
^BUG BOT VIP BY DenzzBanned🗿ꫂ]
╭┈─────────────⩵꙰ཱི
⎙ : *Name Own* : DenzzBanned👑'
⎙ : *Name bot* : VIPbanned👑' 🔥
⎙ : *Nama sc* : denzzbanned.v1 🔥
╰───➤ 
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
